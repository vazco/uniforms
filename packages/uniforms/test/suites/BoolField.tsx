...
export function testBoolField(
  ...
  test.skipIf(!options?.testCheckbox)(
    "<BoolField> - renders a checkbox",
    () => {
      renderWithZod({
  ...
  test.skipIf(!options?.testSwitch)("<BoolField> - renders a switch", () => {
    renderWithZod({
      element: (
  ...
  test.skipIf(!options?.testSwitch)(
  ...
  test.skipIf(!options?.testFitted)(
  ...
  test.skipIf(!options?.testInline)(
