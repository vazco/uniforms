...
export function testSelectField(
  ...
  test.skipIf(!options?.getCheckboxInlineOption)(
  ...
  test.skipIf(!options?.showInlineError)(
  ...
  test.skipIf(options?.showInlineError !== false)(
