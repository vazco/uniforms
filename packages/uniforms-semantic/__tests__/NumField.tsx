...
it('<NumField> - renders correct error text (specified)', () => {
...
it('<NumField> - renders correct error text (showInlineError=false)', () => {
  const error = new Error();
  const element = (
    <NumField
      name="x"
...
it('<NumField> - renders with a custom wrapClassName', () => {
