...
var Num = function Num(_ref) {
    ...
    var props = (0, _objectWithoutProperties3.default)(_ref, ['className', 'decimal', 'disabled', 'error', 'icon', 'iconLeft', 'iconProps', 'id', 'inputRef', 'label', 'max', 'min', 'name', 'onChange', 'placeholder', 'required', 'value']);
