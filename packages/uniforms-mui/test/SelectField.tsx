...
// FIXME:
test.skip("<SelectField> - renders a Select with correct options", () => {
...
test.skip("<SelectField> - renders a Select with correct options (transform)", () => {
  const selectOptions = ["a", "b"] as const;
  renderWithZod({
    element: (
...
// FIXME:
test.skip("<SelectField> - renders a Select which correctly reacts on change", () => {
...
// FIXME:
test.skip("<SelectField> - renders a Select which correctly reacts on change (same value)", () => {
  const onChange = vi.fn();
  renderWithZod({
    element: <SelectField name="x" onChange={onChange} />,
    schema: z.object({ x: z.enum(["a", "b"]) }),
...
// FIXME:
test.skip("<SelectField> - works with special characters", () => {
  renderWithZod({
    element: <SelectField name="x" />,
...
// FIXME:
test.skip("<SelectField> - disabled items (options)", () => {
  renderWithZod({
    element: (
      <SelectField
        name="x"
...
// FIXME:
test.skip("<SelectField checkboxes> - renders a set of Radio buttons with correct disabled state", () => {
  renderWithZod({
...
// FIXME:
test.skip("<SelectField checkboxes> - renders a set of Radio buttons with correct id (inherited)", () => {
  renderWithZod({
    element: <SelectField checkboxes name="x" />,
    schema: z.object({ x: z.enum(["a", "b"]) }),
  });
...
// FIXME:
test.skip("<SelectField checkboxes> - renders a set of Radio buttons with correct id (specified)", () => {
  renderWithZod({
...
// FIXME:
test.skip("<SelectField checkboxes> - renders a set of Radio buttons with correct name", () => {
  renderWithZod({
    element: <SelectField checkboxes name="x" />,
    schema: z.object({ x: z.enum(["a", "b"]) }),
  });
...
// FIXME:
test.skip("<SelectField checkboxes> - renders a set of Radio buttons with correct value (default)", () => {
  renderWithZod({
    element: <SelectField checkboxes name="x" />,
    schema: z.object({ x: z.enum(["a", "b"]) }),
  });
...
// FIXME:
test.skip("<SelectField checkboxes> - renders a set of Radio buttons with correct value (model)", () => {
  renderWithZod({
    element: <SelectField checkboxes name="x" />,
    schema: z.object({ x: z.enum(["a", "b"]) }),
    model: { x: "b" },
...
// FIXME:
test.skip("<SelectField checkboxes> - renders a set of Radio buttons with correct value (specified)", () => {
  renderWithZod({
...
// FIXME:
test.skip("<SelectField checkboxes> - renders a set of Radio buttons which correctly reacts on change", () => {
  const onChange = vi.fn();
...
// FIXME:
test.skip("<SelectField checkboxes> - renders a set of Checkboxes with correct labels", () => {
  renderWithZod({
    element: <SelectField checkboxes name="x" />,
    schema: z.object({
      x: z.string().uniforms({
...
// FIXME:
test.skip("<SelectField checkboxes> - disabled items (checkboxes) based on predicate", () => {
  renderWithZod({
    element: (
      <SelectField
        appearance="checkbox"
