...
var Select = function Select(_ref3) {
    ...
    var props = (0, _objectWithoutProperties3.default)(_ref3, ['allowedValues', 'checkboxes', 'disabled', 'fieldType', 'id', 'inputRef', 'label', 'name', 'onChange', 'placeholder', 'transform', 'value']);
    return _react2.default.createElement(
        'section',
        ...
        checkboxes || fieldType === Array ? renderCheckboxes({ allowedValues: allowedValues, disabled: disabled, id: id, name: name, onChange: onChange, transform: transform, value: value, fieldType: fieldType }) : renderSelect({ allowedValues: allowedValues, disabled: disabled, id: id, name: name, onChange: onChange, transform: transform, value: value, placeholder: placeholder, inputRef: inputRef })
    );
};
