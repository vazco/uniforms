import { gridClassName } from 'uniforms-bootstrap5';
...
test('gridClassName - object', () => {
  ...
  expect(gridClassName({ xl: 9, lg: 2, md: 5, xxl: 3 }, 'input')).toBe(
    'col-7 col-md-7 col-lg-10 col-xl-3 col-xxl-9',
  );
  ...
  expect(gridClassName({ xxl: 3, xl: 9, lg: 2, md: 5 }, 'label')).toBe(
    'col-5 col-md-5 col-lg-2 col-xl-9 col-xxl-3',
  );
  ...
  expect(gridClassName({ xxl: 3 }, 'label')).toBe('col-3 col-xxl-3');
  expect(gridClassName({ xxl: 5 }, 'label')).toBe('col-5 col-xxl-5');
  expect(gridClassName({ xxl: 7 }, 'label')).toBe('col-7 col-xxl-7');
  expect(gridClassName({ xxl: 9 }, 'label')).toBe('col-9 col-xxl-9');
});
