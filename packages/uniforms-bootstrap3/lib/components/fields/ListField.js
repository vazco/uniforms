...
var List = function List(_ref) {
    ...
    var props = (0, _objectWithoutProperties3.default)(_ref, ['children', 'className', 'error', 'initialCount', 'itemProps', 'label', 'name', 'value']);
    return _react2.default.createElement(
        'section',
        (0, _extends3.default)({
            className: (0, _classnames2.default)('panel panel-default', { 'panel-danger': error }, className)
