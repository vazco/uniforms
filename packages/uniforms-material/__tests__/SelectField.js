...
import {SelectField as SelectFieldMaterial} from 'material-ui/SelectField';
...
test('<SelectField> - renders a select with correct placeholder (fallback)', () => {
    ...
    expect(wrapper.find(SelectFieldMaterial)).toHaveLength(1);
    expect(wrapper.find(SelectFieldMaterial).find(MenuItem).find({value: ''})).toHaveLength(1);
    expect(wrapper.find(SelectFieldMaterial).find(MenuItem).find({value: ''}).text()).toBe('y');
});
...
test('<SelectField> - renders a select with correct value (default)', () => {
    ...
    expect(wrapper.find(SelectFieldMaterial)).toHaveLength(1);
    expect(wrapper.find(SelectFieldMaterial).prop('value')).toBe('');
});
...
test('<SelectField> - renders a select which correctly reacts on change', () => {
    ...
    expect(wrapper.find(SelectFieldMaterial)).toHaveLength(1);
    expect(wrapper.find(SelectFieldMaterial).simulate('change', {target: {value: 'b'}})).toBeTruthy();
...
test('<SelectField> - renders a select which correctly reacts on change (empty)', () => {
    ...
    expect(wrapper.find(SelectFieldMaterial)).toHaveLength(1);
    expect(wrapper.find(SelectFieldMaterial).simulate('change', {target: {value: ''}})).toBeTruthy();
...
test('<SelectField> - renders a label', () => {
    ...
    expect(wrapper.find(Subheader).prop('children')).toBe('y');
});
