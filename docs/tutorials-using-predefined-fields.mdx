...
import GuestFormProfessionAdditionalInfo from './components/GuestFormProfessionAdditionalInfo.js';
import GuestFormPredefinedFields from './components/GuestFormPredefinedFields.js';
import GuestFormWithFieldsInSchema from './components/GuestFormWithFieldsInSchema.js';
...
```js
import {AutoField, AutoForm, ErrorField, SubmitField} from 'uniforms-semantic/AutoField';
import React from 'react';
