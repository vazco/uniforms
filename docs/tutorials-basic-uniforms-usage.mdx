...
import BasicUniformsUsageCodeExamples from './components/BasicUniformsUsageCodeExamples';
...
To start using uniforms, we have to install independent three packages:
...
<BasicUniformsUsageCodeExamples />
