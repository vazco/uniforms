...
<CodeSection
  language="js"
  section="schema"
  source={require('!!raw-loader!./examples/Tutorial/GuestSchema4')}
/>
...
<CodeSection
  ...
  source={require('!!raw-loader!./examples/Tutorial/ImageField')}
/>
...
<CodeSection
  language="js"
  replace={{ '../../../website/components/universal': 'uniforms-semantic' }}
  source={require('!!raw-loader!./examples/Tutorial/GuestFormFinal')}
/>
