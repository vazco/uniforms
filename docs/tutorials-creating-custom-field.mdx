...
You can find the whole list of guaranteed props inside the [helpers](api-helpers#connectfieldcomponent-options) section.
  ...
  return (
    <div className="ImageField">
      <label htmlFor="file-input">
        ...
        <img style={{cursor: 'pointer', width: '150px', height: '150px'}} src={value ? value : imgPlaceholder} />
      </label>
      <input accept="image/*" id="file-input" onChange={onImageChange} style={{display: 'none'}} type="file" />
    </div>
  );
}
