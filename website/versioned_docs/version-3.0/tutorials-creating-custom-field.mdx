...
import { GuestFormFinal } from '../../src/pages-parts/Tutorial/GuestFormFinal';
...
<CodeSection
  language="tsx"
  section="schema"
  source={require('!!raw-loader!../../src/pages-parts/Tutorial/GuestSchema4')}
/>
...
You can find the whole list of guaranteed props inside the [helpers](/docs/3.0/api-helpers#connectfieldcomponent-options) section.
...
<CodeSection
  ...
  source={require('!!raw-loader!../../src/pages-parts/Tutorial/ImageField')}
/>
...
<CodeSection
  ...
  source={require('!!raw-loader!../../src/pages-parts/Tutorial/GuestFormFinal')}
/>
