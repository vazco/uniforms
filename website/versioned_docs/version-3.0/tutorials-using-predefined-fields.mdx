...
import { GuestFormPredefinedFields } from '../../src/pages-parts/Tutorial/GuestFormPredefinedFields';
import { GuestFormProfessionAdditionalInfo } from '../../src/pages-parts/Tutorial/GuestFormProfessionAdditionalInfo';
import { GuestFormWithFieldsInSchema } from '../../src/pages-parts/Tutorial/GuestFormWithFieldsInSchema';
import { TutorialForm } from '../../src/components/TutorialForm';
...
<CodeSection
  language="tsx"
  section="schema"
  source={require('!!raw-loader!../../src/pages-parts/Tutorial/GuestSchema2')}
/>
...
<CodeSection
  ...
  source={require('!!raw-loader!../../src/pages-parts/Tutorial/GuestFormProfessionAdditionalInfo')}
/>
...
uniforms provide a set of predefined out-of-the-box [fields](/docs/3.0/api-fields) that we can use instead of the `AutoField`.
...
<CodeSection
  ...
  source={require('!!raw-loader!../../src/pages-parts/Tutorial/GuestFormPredefinedFields')}
/>
...
<CodeSection
  ...
  source={require('!!raw-loader!../../src/pages-parts/Tutorial/GuestFormWithFieldsInSchema')}
/>
...
<CodeSection
  language="tsx"
  section="schema"
  source={require('!!raw-loader!../../src/pages-parts/Tutorial/GuestSchema3')}
/>

What's changed is that now we've included the available options inside the `profession` property definition -
uniforms are smart enough to deduce result field type, thanks to the [`AutoField` algorithm](/docs/3.0/uth-autofield-algorithm).
