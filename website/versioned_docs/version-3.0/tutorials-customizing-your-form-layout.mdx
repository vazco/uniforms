...
import { GuestFormWithAutoFields } from '../../src/pages-parts/Tutorial/GuestFormWithAutoFields';
import { GuestFormWithChangedErrors } from '../../src/pages-parts/Tutorial/GuestFormWithChangedErrors';
import { GuestFormWithErrorFields } from '../../src/pages-parts/Tutorial/GuestFormWithErrorFields';
import { GuestFormWithHeading } from '../../src/pages-parts/Tutorial/GuestFormWithHeading';
...
<CodeSection
  ...
  source={require('!!raw-loader!../../src/pages-parts/Tutorial/GuestFormWithHeading')}
/>
...
<CodeSection
  language="tsx"
  replace={{ "'[^']*?/universal'": "'uniforms-semantic'" }}
  source={require('!!raw-loader!../../src/pages-parts/Tutorial/GuestFormWithAutoFields')}
/>
...
<CodeSection
  language="tsx"
  replace={{ "'[^']*?/universal'": "'uniforms-semantic'" }}
  source={require('!!raw-loader!../../src/pages-parts/Tutorial/GuestFormWithErrorFields')}
/>
...
<CodeSection
  language="tsx"
  replace={{ "'[^']*?/universal'": "'uniforms-semantic'" }}
  source={require('!!raw-loader!../../src/pages-parts/Tutorial/GuestFormWithChangedErrors')}
/>
